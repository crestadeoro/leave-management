        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-area">
                    ...
                    <form method="POST" action="/employee/leave/save-leave/{{ $Employee->id }}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                ...
                                <input type="date" class="form-control @error('date_from') is-invalid @enderror"
                                    ...
                                    id="date_from" name="date_from" autofocus>
                            ...
                            <div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                ...
                                <label for="leave-from">Leave To</label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                ...
                                name="category">
                                    ...
                                    <option value="half day paid" @if(old('category') == 'half day paid') selected @endif>HALF DAY PAID</option>

                                    <option value="paternity leave" @if(old('category') == 'paternity leave') selected @endif>PATERNITY LEAVE</option>
