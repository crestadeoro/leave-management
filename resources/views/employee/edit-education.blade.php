                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <select class="form-control @error('degree')        is-invalid @enderror" id="degree"
                                    ...
                                    <option value="elementary level" @if($education->degree=='elementary level' ) selected @endif>ELEMENTARY LEVEL

                                    </option>

                                    <option value="elementary graduate" @if($education->degree=='elementary graduate' ) selected @endif>ELEMENTARY GRADUATE
