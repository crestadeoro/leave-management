                        ...
                        <div class="row">
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                name="bank_name">
                                    ...
                                    <option value="paid" @if(old('bank_name') == 'paid') selected @endif>East West Bank</option>
                                    <option value="unpaid" @if(old('bank_name') == 'unpaid') selected @endif>Robinson Bank</option>
                                </select>
                            ...
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <input type="text" class="form-control @error('bank_account') is-invalid @enderror"
                                    id="bank_account" name="bank_account" autofocus>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                ...
                                <input type="number" class="form-control @error('basic_rate') is-invalid @enderror"
                                    id="basic_rate" name="basic_rate" autofocus>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <input type="number" class="form-control @error('meal_allowance') is-invalid @enderror"
                                    id="meal_allowance" name="meal_allowance" autofocus>
                            ...
                            <div class="form-group col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <input type="number" class="form-control @error('project_allowance') is-invalid @enderror"
                                    id="project_allowance" name="project_allowance" autofocus>
