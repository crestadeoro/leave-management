...
@section('title', 'Edit Employee Dependent')
    ...
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-warning">Dependent Details</h6>
            ...
            <div class="card-body">
                <div class="form-area">
                    <form method="POST" action="/employee/update-dependent/{{ $dependent->id }}">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <input type="text" class="form-control @error('dependent_name') is-invalid @enderror"
                                    id="dependent_name" name="dependent_name" value="{{ $dependent->dependent_name }}" autofocus>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <input type="date" class="form-control @error('dependent_birthdate') is-invalid @enderror"
                                    id="dependent_birthdate" name="dependent_birthdate" value="{{ $dependent->dependent_birthdate }}">
