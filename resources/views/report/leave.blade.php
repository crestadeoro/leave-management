                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ strtoupper($Employees->position) }}</td>
                                 <td>{{ strtoupper($Employees->date_hired) }}</td>

                                <td>{{ date('F d, Y', strtotime($Employees->date_from)) }}</td>

                                <td>{{ date('F d, Y', strtotime($Employees->date_to)) }}</td>

                                <td>{{ strtoupper($Employees->category) }}</td>
