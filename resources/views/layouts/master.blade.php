...
<head>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="{{ asset('image/cresta-de-oro-icon.png') }}">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseEmployee" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar"
                    @if(stripos(Request::path(), 'employee' ) !==FALSE) show @endif>
                ...
                <div class="topbar-divider d-none d-sm-block"></div> -->
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span
                                    class="mr-2 d-none d-lg-inline text-gray-600 small name-of-user">{{ Auth::user()->name }}</span>
                                <img class="img-profile rounded-circle"
                                    src="{{ asset('image/avatar-icon-images-6.png') }}">
                            </a>
